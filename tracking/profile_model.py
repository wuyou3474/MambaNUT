...
def parse_args():
    ...
    # for train
    parser.add_argument('--script', type=str, default='mambanut', choices=['mambanut'],
                        help='training script name')
    parser.add_argument('--config', type=str, default='mamba_tiny_patch16_224', help='yaml configure file name')
...
if __name__ == "__main__":
    ...
    if args.script == "mambanut":
        model_module = importlib.import_module('lib.models')
        model_constructor = model_module.build_mambanut
